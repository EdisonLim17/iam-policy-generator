...
#############################################
# NAT Gateways + EIPs (1 per public subnet)
#############################################
...
# Private App Subnet A route table (uses NAT A)
...
# Private App Subnet B route table (uses NAT B)
...
# DB subnets don't need internet routes
